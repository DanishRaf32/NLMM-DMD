...
% 1) the full-order EN model of the IEEE-300 bus system,
...
clear;clc;close all
 mpc=case300;      %(see MATPOWER data file)
 ...
 rdefl=25; % Rank for POD and NLMM 
 rdmd=50; % Reduced rank of Koopman operator 
% FOM:
